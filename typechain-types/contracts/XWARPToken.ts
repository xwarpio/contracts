...
export interface XWARPTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DELEGATION_TYPEHASH"
      | "DOMAIN_TYPEHASH"
...
export interface XWARPToken extends BaseContract {
  connect(runner?: ContractRunner | null): XWARPToken;
  waitForDeployment(): Promise<this>;

  interface: XWARPTokenInterface;
