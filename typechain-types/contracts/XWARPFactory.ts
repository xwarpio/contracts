...
export interface XWARPFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "INIT_CODE_PAIR_HASH"
      | "allPairs"
...
export interface XWARPFactory extends BaseContract {
  connect(runner?: ContractRunner | null): XWARPFactory;
  waitForDeployment(): Promise<this>;

  interface: XWARPFactoryInterface;
