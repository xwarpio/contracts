...
export interface XWARPRouterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH"
      | "addLiquidity"
...
export interface XWARPRouter extends BaseContract {
  connect(runner?: ContractRunner | null): XWARPRouter;
  waitForDeployment(): Promise<this>;

  interface: XWARPRouterInterface;
