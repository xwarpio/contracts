...
export interface WXPTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "name"
      | "approve"
...
export interface WXPT extends BaseContract {
  connect(runner?: ContractRunner | null): WXPT;
  waitForDeployment(): Promise<this>;

  interface: WXPTInterface;
