...
export interface XWARPPairInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "MINIMUM_LIQUIDITY"
...
export interface XWARPPair extends BaseContract {
  connect(runner?: ContractRunner | null): XWARPPair;
  waitForDeployment(): Promise<this>;

  interface: XWARPPairInterface;
