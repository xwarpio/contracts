...
export interface IXWARPRouter01Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH"
      | "addLiquidity"
...
export interface IXWARPRouter01 extends BaseContract {
  connect(runner?: ContractRunner | null): IXWARPRouter01;
  waitForDeployment(): Promise<this>;

  interface: IXWARPRouter01Interface;
