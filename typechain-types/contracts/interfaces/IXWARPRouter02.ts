...
export interface IXWARPRouter02Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH"
      | "addLiquidity"
...
export interface IXWARPRouter02 extends BaseContract {
  connect(runner?: ContractRunner | null): IXWARPRouter02;
  waitForDeployment(): Promise<this>;

  interface: IXWARPRouter02Interface;
