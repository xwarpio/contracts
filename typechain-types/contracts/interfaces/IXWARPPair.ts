...
export interface IXWARPPairInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "MINIMUM_LIQUIDITY"
...
export interface IXWARPPair extends BaseContract {
  connect(runner?: ContractRunner | null): IXWARPPair;
  waitForDeployment(): Promise<this>;

  interface: IXWARPPairInterface;
