...
export interface IXWARPFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "INIT_CODE_PAIR_HASH"
      | "allPairs"
...
export interface IXWARPFactory extends BaseContract {
  connect(runner?: ContractRunner | null): IXWARPFactory;
  waitForDeployment(): Promise<this>;

  interface: IXWARPFactoryInterface;
